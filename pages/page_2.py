...
def render_presentation():
    ...
    with ui.column().classes('page-section w-full max-w-6xl mx-auto py-20 px-6 justify-center').style('min-height: calc(100vh - 64px);').props('id=presentation'):
        ...
        with ui.grid(columns=2).classes('w-full gap-8 md:grid-cols-2 lg:grid-cols-2 font-sans'):
            ...
            stats_card('Area Size', '58,800 m²', 'straighten', 'assets/pieces.jpg')
            stats_card('Rooms', '280', 'meeting_room', 'assets/inside.jpg')
